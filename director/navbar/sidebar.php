<aside class="sidebar" id="bg">
    ...
    <ul class="nav flex-column">
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'nuntaburee-tis/director/home') !== false ? 'active-menu' : ''; ?>">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'nuntaburee-tis/director/Personnel_information') !== false ? 'active-menu' : ''; ?>">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Report_a_request.php') !== false ? 'active-menu' : ''; ?>">
            <a class="nav-link d-inline-block" style="font-size: 16px;" href="./Report_a_request.php">
