                    ...
                    <div class="form-group mt-2">
                        ...
                        <div>
                            <select name="position" class="form-control mt-2" id="position" required>
                                ...
                                <option value="7">ครูผู้สอน</option>
                                <option value="8">หัวหน้ากลุ่มสาระการเรียนรู้ภาษาไทย</option>
                                <option value="9">หัวหน้ากลุ่มสาระการเรียนรู้คณิตศาสตร์</option>
                                <option value="10">หัวหน้ากลุ่มสาระการเรียนรู้วิทยาศาสตร์</option>
                                <option value="11">หัวหน้ากลุ่มสาระการเรียนรู้การงานอาชีพ</option>
                                <option value="12">หัวหน้ากลุ่มสาระการเรียนรู้สุขศึกษา</option>
                                <option value="13">หัวหน้ากลุ่มสาระการเรียนรู้สังคมศึกษา</option>
                                <option value="14">หัวหน้ากลุ่มสาระการเรียนรู้ภาษาต่างประเทศ</option>
                                <option value="15">หัวหน้ากลุ่มสาระการเรียนรู้ศิลปะ</option>
                                <option value="16">เจ้าหน้าที่ฝ่ายทั่วไป</option>
                                <option value="17">เจ้าหน้าที่ฝ่ายบุคคล</option>
                                <option value="18">เจ้าหน้าที่ฝ่ายงบประมาณ</option>
                            </select> 
                        </div>
                    </div>
                </div>
