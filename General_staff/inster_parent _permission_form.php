...
$details = $school_name . "," . $reason_controlling . "," . $student_total . "," . $province . "," . $number_of_students . "," . $number_of_supervisor_teachers . "," . $vehicle_used_for_traveling . "," . $date_of_travel . "," . $time . "," . $return_date . "," . $time_return . "," . $cost_per_student . "," . $addIdValues;
