<aside class="sidebar" id="bg">
    ...
    <ul class="nav flex-column">
        ...
        <div style="color: #000000; display: none;" id="subject">
            ...
            <li style="" id="" class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/lecturer/Subject_group_home') !== false ? 'active-menu' : ''; ?>">
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (datas[0].id_subject_group != null && datas[0].id_subject_group != '') {
                ...
                if (id_subject_group == 3 || id_subject_group == 4 || id_subject_group == 5 || id_subject_group == 6 || id_subject_group == 7 || id_subject_group == 8 || id_subject_group == 9 || id_subject_group == 10) {
                ...
                } else if (id_subject_group == 13) {
                    // <!-- เจ้าหน้าที่บุคคล -->
                    $('#subjectperson').show();
                } else if (id_subject_group == 11) {
                    // <!-- เจ้าหน้าที่งบประมาณ -->
                    $('#subjectbudget').show();
                }else if (id_subject_group == 12) {
                    // <!-- เจ้าหน้าที่งบประมาณ -->
                    $('#subjectgeneral').show();
                } 
                else {
