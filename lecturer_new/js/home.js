...
function fetchTotalPetitions(idStatusArray) {
  $.ajax({
    url: "director_get_id_status", // Adjust this URL to the correct endpoint
    method: "POST",
    data: {},
    success: function (response) {
...
$(document).ready(function () {
  $.ajax({
    url: "director_get_count_personnel",
    method: "POST",
    dataType: "json",
...
$(document).ready(function () {
  ...
  $("#exampleModal5").on("show.bs.modal", function (e) {
    ...
    $.ajax({
      url: "director_get_all_staff.php", // Adjusted URL to include .php extension
      method: "GET",
      success: function (response) {
  ...
  $("#exampleModal4").on("show.bs.modal", function (e) {
    ...
    $.ajax({
      url: "director_get_all_requests", // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
      method: "GET",
  ...
  $("#exampleModal2").on("show.bs.modal", function (e) {
    // เรียกใช้งานข้อมูลผ่าน AJAX
    $.ajax({
      url: "director_get_all_approve", // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
      method: "GET",
      data: {
        id_status: 4, // ส่งค่านี้ไปด้วยหากสคริปต์ PHP ของคุณต้องการ
      },
  ...
  $("#exampleModal1").on("show.bs.modal", function (e) {
    // เรียกใช้งานข้อมูลผ่าน AJAX
    $.ajax({
      url: "director_get_all_waiting_for_approval", // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
      method: "GET",
      data: {
        id_status: 3, // ส่งค่านี้ไปด้วยหากสคริปต์ PHP ของคุณต้องการ
      },
