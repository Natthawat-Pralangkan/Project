    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            employees.forEach(function(employee) {
                ...
                employeeDropdown.append('<option value="' + employee.user_id + '" data-user_name="' + employee.user_name + '" data-last_name="' + employee.last_name + '" data-name_type="' + employee.name_type + '" data-position="' + employee.position + '">' + employeeName + '</option>');
            });
        },
        error: function(xhr, status, error) {
