<aside class="sidebar" id="bg">
    <div class="text-center my-4" style="height : 28px">
        <h4 id="title_web" class="text-white">NUNTABUREE-รองผู้อำนวยการ</h4>
    </div>
    <ul class="nav flex-column">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/Director_DeputyDirector/director/Personnel_information') !== false ? 'active-menu' : ''; ?>">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/Director_DeputyDirector/director/check_the_request') !== false ? 'active-menu' : ''; ?>">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/Director_DeputyDirector/director/Petition_history') !== false ? 'active-menu' : ''; ?>">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/Director_DeputyDirector/director/Report_on_entry_and_exit_times') !== false ? 'active-menu' : ''; ?>">
