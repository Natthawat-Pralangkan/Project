<aside class="sidebar" id="bg">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item ms-3 me-1 py-1 <?php echo strpos($_SERVER['REQUEST_URI'], 'Project/Director_DeputyDirector/director/check_consider_and_approve_the_request') !== false ? 'active-menu' : ''; ?>">
