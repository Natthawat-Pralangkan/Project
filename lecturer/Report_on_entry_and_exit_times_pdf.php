...
$user_id = $_GET['user_id'] ?? ''; // ใส่ค่าเริ่มต้นเพื่อป้องกัน error
...
$query = "SELECT * FROM face_recognition_data WHERE created_at BETWEEN :start_date AND :end_date AND user_id = :user_id";
