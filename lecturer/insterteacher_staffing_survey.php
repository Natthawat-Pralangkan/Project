...
$id_subject_group = $_POST["id_subject_group_4"];
$user_id = $_POST["user_id"];

$details =  $semester . "," . $school_yea . "," . $teacher_total_now . "," . $teacher_total_out . "," . $teacher_total_broken . "," . $teacher_broken_reason . "," . $teacher_total_over . "," . $teacher_over_reason . "," . $teacher_total_add . "," . $teacher_add_reason;
// Prepared Statemen
