$(document).ready(function () {
    $("#server_from").click(function () {
      ...
      var petition_name = $("#petition_name_1").val();
      ...
      console.log(name_from+' '+petition_name+' '+date_report_send+' '+document_name_consider+' '+subject_group+' '+activity_name+' '+according_project+''+date_activity+''+activity_where+''+summary_details);
      $.ajax({
