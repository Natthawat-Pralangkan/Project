...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <script src="./js/academic_Request_a_time_entry_and_exit_report.js"></script>
...
<script>
    ...
    function createPDF() {
        ...
        var idtype = localStorage.getItem("id_type"); // Properly retrieve the user_id from localStorage

        // Include user_id in the URL parameters
        window.open(`./academic_Report_on_entry_and_exit_times_pdf.php?start_date=${startDate}&end_date=${endDate}&id_type=${idtype}`, '_blank');
    }
</script>
