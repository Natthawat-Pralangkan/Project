...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <script src="./js/deputy_director_Personnel_information.js"></script>
            ...
            WHERE teacher_personnel_information.position IN (2, 3, 4, 5, 6, 7) and teacher_personnel_information.status in (0) ORDER BY id DESC";
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><button class="btn" style="background-color: #BB6AFB; color:#FFFFFF" onclick="window.location.href='deputy_director_get_information.php?id=<?php echo $row['id']; ?>'">ดูรายละเอียด</button></td>
                                </tr>
                    <?php
                            }
                        } else {
