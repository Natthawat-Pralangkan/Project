...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#exampleModal1').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                url: 'general_get_Request_pending_consideration', // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
                method: 'GET',
                data: {
    ...
    $(document).ready(function() {
        ...
        $('#exampleModal4').on('show.bs.modal', function(e) {
            // เรียกใช้งานข้อมูลผ่าน AJAX
            $.ajax({
                url: 'general_get_all_requests', // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
                method: 'GET',
                data: {
                    petition_type: 2
    ...
    function fetchTotalPetitions(idStatusArray) {
        $.ajax({
            url: 'general_get_id_status', // Adjust this URL to the correct endpoint
            method: 'POST',
            data: {
