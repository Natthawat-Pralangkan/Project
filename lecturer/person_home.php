...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#exampleModal1').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                url: 'person_get_Request_pending_consideration', // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
                method: 'GET',
                data: {
    ...
    $(document).ready(function() {
        ...
        $('#exampleModal4').on('show.bs.modal', function(e) {
            // เรียกใช้งานข้อมูลผ่าน AJAX
            $.ajax({
                url: 'person_get_all_requests', // เปลี่ยนเป็นเส้นทางของสคริปต์ PHP ของคุณ
                method: 'GET',
                data: {
                    petition_type: 4
    ...
    function fetchTotalPetitions(idStatusArray) {
        $.ajax({
            url: 'person_get_id_status', // Adjust this URL to the correct endpoint
            method: 'POST',
            data: {
    ...
    $(document).ready(function() {
        ...
        $('#exampleModal5').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                url: 'person_get_all_staff.php', // Adjusted URL to include .php extension
                method: 'GET',
                success: function(response) {
    ...
    function fetchTotalPetitions_get_all_staff_0(get_all_staff_0) {
        $.ajax({
            url: 'person_get_count_all_staff', // Adjust this URL to the correct endpoint
            method: 'POST',
            data: {
